...
const App=()=>{
    ...
    return(
        <>
    <input  id="id1" name="data-testid=input1" data-testid="input1" onChange={(e)=>setInput1Value(e.target.value)}></input>
    <input  id="id2" name="data-testid=input2" data-testid="input2" onChange={(e)=>setInput2Value(e.target.value)}></input>
